...
import { logEvent } from '../common/utils/event-logger';
...
export class StaysService {
  ...
  async checkIn(
    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      this.metrics.recordBusinessEvent('stay_check_in');
      logEvent('stay_check_in', {
        roomId,
        stayId: stay.id,
      });
  ...
  async checkOut(
    ...
    return this.prisma.$transaction(async (tx) => {
      ...
      this.metrics.recordBusinessEvent('stay_check_out');
      logEvent('stay_check_out', {
        roomId,
        stayId: stay.id,
      });
